...
class LimeDiceBreak(models.Model):
    user            = models.ForeignKey(User, on_delete=models.CASCADE)
    name            = models.CharField(max_length=50, default="Rotura Dados Cal")
    ...
    def save(self, *args, **kwargs):
        ...
        super(LimeDiceBreak, self).save(*args, **kwargs)

    def __str__(self):
        return f"Dado de Cal {self.id}"
