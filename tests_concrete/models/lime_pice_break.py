...
class LimePiceBreak(models.Model):
    user            = models.ForeignKey(User, on_delete=models.CASCADE)
    name            = models.CharField(max_length=50, default="Rotura Testigo Cal")
    ...
    def save(self, *args, **kwargs):
        ...
        super(LimePiceBreak, self).save(*args, **kwargs)

    def __str__(self):
        return f"Testigo de Cal {self.id}"