...
class GranulometicWashing(models.Model):
    LAYER_CHOICES = (
        ("UNO", "Estrato 1"),
        ("DOS", "Estrato 2"),
        ("TRES", "Estrato 3"),
    ...
    name            = models.CharField(max_length=50, default="Granulometria Tamizado Lavado")
    ...
    tamiz_grueso_ret    = models.FloatField(null=True, blank=True)
    ...
    tamiz_fino_ret      = models.FloatField(null=True, blank=True)
    ...
    def save(self, *args, **kwargs):
        ...
        super(GranulometicWashing, self).save(*args, **kwargs)
    
    def __str__(self):
        return f"Granulometria Tamizado Lavado {self.id}"